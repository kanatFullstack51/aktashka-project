		...
		<div className={styles.call}>
			<div className={styles.call_inner}>
				<div className={styles.call_block}>
					...
					<div className={styles.call_form_block}>
						<form
						...
						>
							...
							<div className={styles.call_checkbox_block}>
								<input
									...
									name="call_checkbox"
									type='checkbox'
									className={styles.call_checkbox}
								/>
								<label for='call_checkbox'></label>
								<p className={styles.call_checkbox_text}>Я соглашаюсь с <span>политикой конфиденциальности</span> сайта</p>
							</div>
							<div className={styles.call_button}>
								<Button
									children={'Получите расчет'}
								/>
							</div>
						</form>
					</div>

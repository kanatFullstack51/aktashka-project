			...
			<div className={styles.done_inner}>
				...
				<div className={styles.done_block}>
					<div className={styles.done_list}>
						<Dropdown
							TitleContent={'Более 10 лет на рынке'}
							TextContent={'Строим монолитные конструкции'}
						/>
						<Dropdown
							TitleContent={'Ежедневный отчет'}
							TextContent={'Строим монолитные конструкции'}
						/>
						<Dropdown
							TitleContent={'Бесплатный замер'}
							TextContent={'Строим монолитные конструкции'}
						/>
						<Dropdown
							TitleContent={'Гарантия'}
							TextContent={'Строим монолитные конструкции'}
						/>
						<Dropdown
							TitleContent={'Соблюдаем сроки'}
							TextContent={'Строим монолитные конструкции'}
						/>
					</div>
				</div>

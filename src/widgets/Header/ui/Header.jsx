          ...
          <div className={styles.navigation_inner}>
            <ul className={styles.navigation_link}>
              ...
              {listItems
                ...
                .map((item) => {
                  return (
                    <li className={styles.navigation_text} key={item.main}>
                      {item.main}
                    </li>
                  );
                })}
              {listItems
                ...
                .map((item) => {
                  return (
                    <li className={styles.navigation_text} key={item.projects}>
                      {item.projects}
                    </li>
                  );
                })}
              {listItems
                ...
                .map((item) => {
                  return (
                    <li className={styles.navigation_text} key={item.price}>
                      {item.price}
                    </li>
                  );
                })}
              {listItems
                ...
                .map((item) => {
                  return (
                    <li className={styles.navigation_text} key={item.services}>
                      {item.services}
                    </li>
                  );
                })}
              {listItems
                ...
                .map((item) => {
                  return (
                    <li className={styles.navigation_text} key={item.contacts}>
                      {item.contacts}
                    </li>
                  );
                })}
          ...
          <div className={styles.phone_consultation}>
            <div className={styles.phone_consultation_inner}>
              ...
              <div className={styles.phone_consultation_btn_block}>
                <Button type="button" onClick={() => setOpenModal(true)} children="Заказать Звонок" />
              </div>
            </div>
          </div>
